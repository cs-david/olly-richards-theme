<?php
/**
 * The template for displaying my-courses archive page
 *
	...
	<main id="primary" class="site-main">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<div class="wrap">
					<div class="archive-header-columns">
						<div class="ahc-left">
                            <?php 
                            $page_id = get_page_by_path('my-courses')->ID;
                            ?>
			...
			<div class="wrap filter-container">
                <?php echo do_shortcode('[searchandfilter field="11"]'); ?>
                <?php echo do_shortcode('[searchandfilter field="5"]'); ?>
            </div>
			...
			echo do_shortcode('[searchandfilter field="4"]');
